...
Há também a possibilidade de rodar os códigos, bastando acessar a pasta `src/`. Certifique-se de que o arquivo de dados `quotes_2008-08.txt` esteja presente na pasta `data/`. Em seguida, rode os scripts na ordem numérica: 01_extracao_grafo.py, 02_analise_basica.py, 03_desempenho_algoritmos.py e 04_analise_avancada.py.
